...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument(
            ...
            type=int,
            default=99999999,
            help="number of epochs to stop training",
        )
        parser.add_argument(
            "--partial_train",
            type=str,
            default="1",
            help="only use partial training samples (0-1)",
        )
        parser.add_argument(
            "--max_iters",
            type=int,
            default=100000,
            help="maximum iterations. Training will stop after that.",
        )
        parser.add_argument(
            "--beta1", type=float, default=0.9, help="momentum term of adam"
        )  # was 0.5 in the paper experiments
        parser.add_argument(
        ...
        parser.add_argument(
            ...
            type=int,
            default=1,
            help="number of iters to accumulate gradient",
        )
        parser.add_argument(
            "--lr",
            type=float,
        ...
        parser.add_argument(
            ...
            type=int,
            default=999,
            help="number of samples for validation during training",
        )
        self.isTrain = True
        return parser
